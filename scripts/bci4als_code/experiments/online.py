...
from bci4als.ml_model import MLModel #TODO: change to our model
...
class OnlineExperiment(Experiment):
    ...
    def __init__(self, eeg: EEG, model: MLModel, num_trials: int,
        ...
        self.audio_success_path = 'scripts/bci4als_code/experiments/audio/success.mp3'
